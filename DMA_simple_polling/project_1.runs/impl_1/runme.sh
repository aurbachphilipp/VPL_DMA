...
HD_PWD='/home/rom41797/Documents/Project/DMA_demo_no_SG/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_demo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_demo_wrapper.tcl -notrace
