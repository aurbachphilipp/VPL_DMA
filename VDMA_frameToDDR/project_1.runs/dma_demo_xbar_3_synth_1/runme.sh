...
HD_PWD='/home/rom41797/Documents/Project/VDMA_simple_polling_v2/project_1.runs/dma_demo_xbar_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_demo_xbar_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_demo_xbar_3.tcl
