...
#define BUFFER_BYTESIZE		16	/* Length of the buffers for DMA
					 * transfer
					 */
...
//u8 *DestBuffer = (u8 *)XPAR_BRAM_0_BASEADDR;
...
static int CheckData(u8 *SrcPtr, u8 *DestPtr, int Length)
{
	...
	for (Index = 0; Index < Length; Index++) {
		...
		//xdbg_printf(SrcPtr[Index], " Source\n");
		//xdbg_printf(DestPtr[Index], " Destination\n");
	}
