...
HD_PWD='/home/rom41797/Documents/Project/CDMA_simple_polling_DDR/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_demo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_demo_wrapper.tcl
