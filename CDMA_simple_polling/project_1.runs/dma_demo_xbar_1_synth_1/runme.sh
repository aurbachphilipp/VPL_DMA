...
HD_PWD='/home/rom41797/Documents/Project/CDMA_simple_polling/project_1.runs/dma_demo_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_demo_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_demo_xbar_1.tcl
